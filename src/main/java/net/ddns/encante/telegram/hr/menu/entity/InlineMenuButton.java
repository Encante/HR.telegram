...
import net.ddns.encante.telegram.hr.telegram.api.objects.CallbackGame;
import net.ddns.encante.telegram.hr.telegram.api.objects.InlineKeyboardButton;
import net.ddns.encante.telegram.hr.telegram.api.objects.LoginUrl;
import net.ddns.encante.telegram.hr.telegram.api.objects.WebAppInfo;
